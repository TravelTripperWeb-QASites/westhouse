...
ProjectionHelperOverlay.prototype.LatToY_ = function(lat) {
    ...
    return 1 - .5 / Math.PI * Math.log((1 + sinofphi) / (1 - sinofphi));
};
...
ProjectionHelperOverlay.prototype.LatLngToPixel = function(latlng, zoom) {
    ...
    var abs = {
        x: ~~(.5 + this.LngToX_(latlng.lng()) * (2 << zoom + 6)),
        y: ~~(.5 + this.LatToY_(latlng.lat()) * (2 << zoom + 6))
    };
    return abs;
};
...
(function() {
    ...
    StyledIconTypes.MARKER = {
        ...
        getShape: function(props, width, height) {
            var _iconmap = {};
            _iconmap.coord = [ width / 2, height, 7 / 16 * width, 5 / 8 * height, 5 / 16 * width, 7 / 16 * height, 7 / 32 * width, 5 / 16 * height, 5 / 16 * width, 1 / 8 * height, 1 / 2 * width, 0, 11 / 16 * width, 1 / 8 * height, 25 / 32 * width, 5 / 16 * height, 11 / 16 * width, 7 / 16 * height, 9 / 16 * width, 5 / 8 * height ];
    ...
    StyledIconTypes.BUBBLE = {
        ...
        getShape: function(props, width, height) {
            var _iconmap = {};
            _iconmap.coord = [ 0, 44, 13, 26, 13, 6, 17, 1, width - 4, 1, width, 6, width, 21, width - 4, 26, 21, 26 ];
            _iconmap.type = "poly";
            return _iconmap;
        }
    };
    ...
    $.jMapping = function(map_elm, options) {
        ...
        if (!$(map_elm).data("jMapping")) {
            ...
            var getBounds = function(doUpdate) {
                var places_data = getPlacesData(doUpdate), newBounds = null, point;
            ...
            var setupLink = function(place_elm) {
                var $place_elm = $(place_elm), location_data = $place_elm.metadata(settings.metadata_options), link = $place_elm.find(settings.link_selector);
            ...
            var createMarker = function(place_elm) {
                var $place_elm = $(place_elm), place_data, point, marker, iconimage, iconimg, $info_window_elm, info_window;
...
(function(e) {
    ...
    function t(t, s) {
        ...
        return "area" === o ? (a = t.parentNode, n = a.name, t.href && n && "map" === a.nodeName.toLowerCase() ? (r = e("img[usemap='#" + n + "']")[0], 
    ...
    e.extend(a.prototype, {
        ...
        _dialogDatepicker: function(t, i, s, a, n) {
            ...
            return c || (this.uuid += 1, r = "dp" + this.uuid, this._dialogInput = e("<input type='text' id='" + r + "' style='position: absolute; top: -100px; width: 0px;'/>"), 
            ...
            o(c.settings, a || {}), i = i && i.constructor === Date ? this._formatDate(c, i) : i, 
        ...
        _optionDatepicker: function(t, i, s) {
            ...
            n = this._getDateDatepicker(t, !0), r = this._getMinMaxDate(l, "min"), h = this._getMinMaxDate(l, "max"), 
            o(l.settings, a), null !== r && void 0 !== a.dateFormat && void 0 === a.minDate && (l.settings.minDate = this._formatDate(l, r)), 
        ...
        _doKeyDown: function(t) {
            ...
            if (n._keyEvent = !0, e.datepicker._datepickerShowing) switch (t.keyCode) {
              ...
              case 37:
                ...
                r = t.ctrlKey || t.metaKey, t.originalEvent.altKey && e.datepicker._adjustDate(t.target, t.ctrlKey ? -e.datepicker._get(n, "stepBigMonths") : -e.datepicker._get(n, "stepMonths"), "M");
                break;
        ...
        _showDatepicker: function(t) {
            ...
            !e.datepicker._isDisabledDatepicker(t) && e.datepicker._lastInput !== t) {
                ...
                a = e.datepicker._get(i, "beforeShow"), n = a ? a.apply(t, [ t, i ]) : {}, n !== !1 && (o(i.settings, n), 
                ...
                e.datepicker._pos[1] += t.offsetHeight), r = !1, e(t).parents().each(function() {
        ...
        _updateDatepicker: function(t) {
            ...
            o.length > 0 && r.apply(o.get(0)), t.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), 
        ...
        _checkOffset: function(t, i, s) {
            ...
            return i.left -= this._get(t, "isRTL") ? a - r : 0, i.left -= s && i.left === t.input.offset().left ? e(document).scrollLeft() : 0, 
        ...
        _hideDatepicker: function(t) {
            ...
            s = this._get(r, "duration"), a = function() {
            ...
            i || a(), this._datepickerShowing = !1, n = this._get(r, "onClose"), n && n.apply(r.input ? r.input[0] : null, [ r.input ? r.input.val() : "", r ]), 
        ...
        parseDate: function(t, i, s) {
            ...
            for (a = 0; t.length > a; a++) if (b) "'" !== t.charAt(a) || _("'") ? w() : b = !1; else switch (t.charAt(a)) {
              ...
              case "!":
                o = new Date((x("!") - this._ticksTo1970) / 1e4), m = o.getFullYear(), g = o.getMonth() + 1, 
                v = o.getDate();
                break;
        ...
        _determineDate: function(t, i, s) {
            ...
            return r = r && "Invalid Date" == "" + r ? s : r, r && (r.setHours(0), r.setMinutes(0), 
        ...
        _setDate: function(e, t, i) {
            ...
            e.selectedDay = e.currentDay = r.getDate(), e.drawMonth = e.selectedMonth = e.currentMonth = r.getMonth(), 
            e.drawYear = e.selectedYear = e.currentYear = r.getFullYear(), a === e.selectedMonth && n === e.selectedYear || i || this._notifyChange(e), 
        ...
        _generateHTML: function(e) {
            ...
            0 > Z && (Z = 11, et--);
            for (e.drawMonth = Z, e.drawYear = et, i = this._get(e, "prevText"), i = K ? this.formatDate(i, this._daylightSavingAdjust(new Date(et, Z - U, 1)), this._getFormatConfig(e)) : i, 
            ...
            a = this._get(e, "nextText"), a = K ? this.formatDate(a, this._daylightSavingAdjust(new Date(et, Z + U, 1)), this._getFormatConfig(e)) : a, 
            ...
            r = this._get(e, "currentText"), o = this._get(e, "gotoCurrent") && e.currentDay ? Q : R, 
            r = K ? this.formatDate(r, o, this._getFormatConfig(e)) : r, h = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", 
            ...
            y = this._get(e, "selectOtherMonths"), b = this._getDefaultDate(e), _ = "", k = 0; V[0] > k; k++) {
                for (w = "", this.maxRows = 4, T = 0; V[1] > T; T++) {
                    ...
                    for (M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === k ? Y ? n : s : "") + (/all|right/.test(S) && 0 === k ? Y ? s : n : "") + this._generateMonthYearHeader(e, Z, et, X, $, k > 0 || T > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>", 
                    N = d ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", 
                    x = 0; 7 > x; x++) C = (x + u) % 7, N += "<th scope='col'" + ((x + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + c[C] + "'>" + p[C] + "</span></th>";
                    for (M += N + "</tr></thead><tbody>", A = this._getDaysInMonth(et, Z), et === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, A)), 
                    I = (this._getFirstDayOfMonth(et, Z) - u + 7) % 7, P = Math.ceil((I + A) / 7), F = G ? this.maxRows > P ? this.maxRows : P : P, 
                    this.maxRows = F, H = this._daylightSavingAdjust(new Date(et, Z, 1 - I)), z = 0; F > z; z++) {
                        for (M += "<tr>", j = d ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(H) + "</td>" : "", 
                        x = 0; 7 > x; x++) E = g ? g.apply(e.input ? e.input[0] : null, [ H ]) : [ !0, "" ], 
                        O = H.getMonth() !== Z, L = O && !y || !E[0] || X && X > H || $ && H > $, j += "<td class='" + ((x + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (O ? " ui-datepicker-other-month" : "") + (H.getTime() === D.getTime() && Z === e.selectedMonth && e._keyEvent || b.getTime() === H.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (O && !v ? "" : " " + E[1] + (H.getTime() === Q.getTime() ? " " + this._currentClass : "") + (H.getTime() === R.getTime() ? " ui-datepicker-today" : "")) + "'" + (O && !v || !E[2] ? "" : " title='" + E[2].replace(/'/g, "&#39;") + "'") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + H.getMonth() + "' data-year='" + H.getFullYear() + "'") + ">" + (O && !v ? "&#xa0;" : L ? "<span class='ui-state-default'>" + H.getDate() + "</span>" : "<a class='ui-state-default" + (H.getTime() === R.getTime() ? " ui-state-highlight" : "") + (H.getTime() === Q.getTime() ? " ui-state-active" : "") + (O ? " ui-priority-secondary" : "") + "' href='#'>" + H.getDate() + "</a>") + "</td>", 
                        H.setDate(H.getDate() + 1), H = this._daylightSavingAdjust(H);
                        M += j + "</tr>";
                    }
                    Z++, Z > 11 && (Z = 0, et++), M += "</tbody></table>" + (G ? "</div>" + (V[0] > 0 && T === V[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), 
                    w += M;
                }
                _ += w;
            }
        ...
        _generateMonthYearHeader: function(e, t, i, s, a, n, r, o) {
            ...
            if (n || !g) _ += "<span class='ui-datepicker-month'>" + r[t] + "</span>"; else {
                ...
                u = 0; 12 > u; u++) (!h || u >= s.getMonth()) && (!l || a.getMonth() >= u) && (_ += "<option value='" + u + "'" + (u === t ? " selected='selected'" : "") + ">" + o[u] + "</option>");
                _ += "</select>";
            }
        ...
        _isInRange: function(e, t) {
            ...
            return h && (i = h.split(":"), s = new Date().getFullYear(), r = parseInt(i[0], 10), 
            o = parseInt(i[1], 10), i[0].match(/[+\-].*/) && (r += s), i[1].match(/[+\-].*/) && (o += s)), 
...
(function(T, P, u) {
    ...
    function q(a, b, d) {
        ...
        } else if (a.forEach && a.forEach !== q) a.forEach(b, d, a); else if (oc(a)) for (c in a) b.call(d, a[c], c, a); else if ("function" === typeof a.hasOwnProperty) for (c in a) a.hasOwnProperty(c) && b.call(d, a[c], c, a); else for (c in a) va.call(a, c) && b.call(d, a[c], c, a);
        return a;
    }
    function pc(a, b, d) {
    ...
    function pa(a, b) {
        function d(a, b) {
            ...
            } else if (oc(a)) for (e in a) b[e] = c(a[e]); else if (a && "function" === typeof a.hasOwnProperty) for (e in a) a.hasOwnProperty(e) && (b[e] = c(a[e])); else for (e in a) va.call(a, e) && (b[e] = c(a[e]));
    ...
    function xc(a) {
        ...
        q((a || "").split("&"), function(a) {
            ...
            f = a.substring(c + 1)), e = wc(e), A(e) && (f = A(f) ? wc(f) : !0, va.call(b, e) ? M(b[e]) ? b[e].push(f) : b[e] = [ b[e], f ] : b[e] = f));
        });
        return b;
    }
    function Sb(a) {
    ...
    function he() {
        ...
        if (!Ac) {
            ...
            ($ = z(b) ? T.jQuery : b ? T[b] : u) && $.fn.on ? (H = $, S($.fn, {
                ...
                for (var c, e = 0, f; null != (f = b[e]); e++) (c = $._data(f, "events")) && c.$destroy && $(f).triggerHandler("$destroy");
                a(b);
            }) : H = U;
            ea.element = H;
            Ac = !0;
    ...
    function ub(a) {
        for (var b = a[0], d = a[a.length - 1], c, e = 1; b !== d && (b = b.nextSibling); e++) if (c || a[e] !== b) c || (c = H(Aa.call(a, 0, e))), 
        c.push(b);
        return c || a;
    }
    function V() {
    ...
    function gb(a, b) {
        ...
        Oc(a)), delete hb[d], a.ng339 = u));
    }
    function yb(a, b) {
        var d = a.ng339, d = d && hb[d];
        b && !d && (a.ng339 = d = ++Mf, d = hb[d] = {
            events: {},
            data: {},
            handle: u
        });
        ...
        function g(a) {
            ...
            q(a, function(a) {
                ...
                if (!m.get(a)) {
                    m.put(a, !0);
                    try {
                        y(a) ? (c = Tb(a), b = b.concat(g(c.requires)).concat(c._runBlocks), d(c._invokeQueue), 
    ...
    function cf() {
        this.$get = function() {
            function a(a, c) {
                ...
                var g = 0, h = S({}, c, {
                    id: a
                }), k = V(), l = c && c.capacity || Number.MAX_VALUE, m = V(), n = null, p = null;
                return b[a] = {
                    put: function(a, b) {
                        if (!z(b)) {
        ...
        this.$get = [ "$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, m, v, Q, t, G, C, K) {
            ...
            function xa(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    m = 0;
                    for (n = h.length; m < n; ) k = G[h[m++]], c = h[m++], f = h[m++], c ? (c.scope ? (l = a.$new(), 
                    ba.$$addScopeInfo(H(k), l)) : l = a, p = c.transcludeOnThisElement ? s(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? s(a, b) : null, 
                ...
                switch (a.nodeType) {
                  case 1:
                    ...
                    for (var l, m, n, r = a.attributes, p = 0, G = r && r.length; p < G; p++) {
                        ...
                        m = W(l.value);
                        l = ya(k);
                        if (n = za.test(l)) k = k.replace(Vc, "").substr(8).replace(/_(.)/g, function(a, b) {
                    ...
                    a = a.className;
                    J(a) && (a = a.animVal);
                    if (y(a) && "" !== a) for (;k = g.exec(a); ) l = ya(k[2]), Fa(b, l, "C", d, e) && (c[l] = W(k[3])), 
                    a = a.substr(k.index + k[0].length);
                    break;

                  case Pa:
                    if (11 === Da) for (;a.parentNode && a.nextSibling && a.nextSibling.nodeType === Pa; ) a.nodeValue += a.nextSibling.nodeValue, 
            ...
            function ra(a, b, d, e, f, g, h, k, l) {
                ...
                function n(a, c, e, f, g) {
                    ...
                    ba.$$addScopeClass(t, !0), B.$$isolateBindings = C.$$isolateBindings, (p = ha(c, f, B, B.$$isolateBindings, C)) && B.$on("$destroy", p));
                    for (r in K) {
                        p = v[r];
                        var Va = K[r], Q = p.$$bindings.bindToController;
                        Va.identifier && Q && (m = ha(I, f, Va.instance, Q, p));
                        var L = Va();
                        L !== Va.instance && (Va.instance = L, t.data("$" + p.name + "Controller", L), m && m(), 
                ...
                for (var p = -Number.MAX_VALUE, G = l.newScopeDirective, v = l.controllerDirectives, C = l.newIsolateScopeDirective, w = l.templateDirective, I = l.nonTlbTranscludeDirective, K = !1, x = !1, Ca = l.hasElementTranscludeDirective, t = d.$$element = H(b), B, L, Q, s = e, xa, Ea = !1, E = !1, y, ra = 0, N = a.length; ra < N; ra++) {
                    ...
                    if (y = B.scope) B.templateUrl || (J(y) ? (X("new/isolated scope", C || G, B, t), 
                    C = B) : X("new/isolated scope", C, B, t)), G = G || B;
                    L = B.name;
                    ...
                    !B.templateUrl && B.controller && (y = B.controller, v = v || V(), X("'" + L + "' controller", v[L], B, t), 
                    v[L] = B);
                    if (y = B.transclude) if (K = !0, B.$$tlb || (X("transclusion", I, B, t), I = B), 
                    "element" == y) Ca = !0, p = B.priority, Q = t, t = d.$$element = H(ba.$$createComment(L, d[L])), 
                    b = t[0], da(f, Aa.call(Q, 0), b), Q[0].$$parentNode = Q[0].parentNode, s = Zb(E, Q, e, p, g && g.name, {
                    ...
                    if (B.template) if (x = !0, X("template", w, B, t), w = B, y = D(B.template) ? B.template(t, d) : B.template, 
                    y = ua(y), B.replace) {
                        g = B;
                    ...
                    if (B.templateUrl) x = !0, X("template", w, B, t), w = B, B.replace && (g = B), 
            ...
            function aa(a, b, c, d, e, f, g, h) {
                ...
                m(v).then(function(m) {
                    ...
                    if (r.replace) {
                        ...
                        w = m[0];
                        if (1 != m.length || 1 !== w.nodeType) throw ga("tplrt", r.name, v);
                        m = {
                            $attr: {}
                        };
                        da(d, b, w);
            ...
            function ha(a, c, d, e, f) {
                function g(b, c, e) {
                    D(d.$onChanges) && c !== e && ($ || (a.$$postDigest(I), $ = []), l || (l = {}, $.push(h)), 
                    l[b] && (e = l[b].previousValue), l[b] = {
                        previousValue: e,
                        currentValue: c
                    });
                }
            ...
            qa.prototype = {
                ...
                $set: function(a, b, d, e) {
                    ...
                    if ("a" === f && ("href" === a || "xlinkHref" === a) || "img" === f && "src" === a) this[a] = b = K(b, "src" === a); else if ("img" === f && "srcset" === a) {
                        for (var f = "", g = W(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(g) ? k : /(,)/, g = g.split(k), k = Math.floor(g.length / 2), l = 0; l < k; l++) var m = 2 * l, f = f + K(W(g[m]), !0), f = f + (" " + W(g[m + 1]));
                        g = W(g[2 * l]).split(/\s/);
                        f += K(W(g[0]), !0);
                        2 === g.length && (f += " " + W(g[1]));
                        this[a] = b = f;
    ...
    function df() {
        ...
        this.$get = [ "$injector", "$window", function(d, c) {
            ...
            return function(f, g, h, k) {
                ...
                if (h) return h = (M(f) ? f[f.length - 1] : f).prototype, l = Object.create(h || null), 
                n && e(g, n, l, m || f.name), S(function() {
    ...
    function kf() {
        ...
        this.$get = [ "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, g, h, k, l) {
            ...
            function n(c, d) {
                ...
                K && (I = K.get(L), A(I) ? I && D(I.then) ? I.then(n, n) : M(I) ? l(I[1], I[0], ia(I[2]), I[3]) : l(I, 200, {}, "OK") : K.put(L, C));
    ...
    function hf() {
        ...
        this.$get = [ "$parse", "$exceptionHandler", "$sce", function(d, c, e) {
            ...
            function k(f, k, n, r) {
                ...
                var q, t, G = 0, C = [], K = [];
                v = f.length;
                for (var I = [], qa = []; G < v; ) if (-1 != (q = f.indexOf(a, G)) && -1 != (t = f.indexOf(b, q + l))) G !== q && I.push(g(f.substring(G, q))), 
                G = f.substring(q + l, t), C.push(G), K.push(d(G, p)), G = t + m, qa.push(I.length), 
                I.push(""); else {
    ...
    function ec(a, b, d) {
        ...
        this.$$parse = function(c) {
            ...
            z(e) || "#" !== e.charAt(0) ? this.$$html5 ? f = e : (f = "", z(e) && (a = c, this.replace())) : (f = la(d, e), 
            z(f) && (f = e));
            id(f, this);
            c = this.$$path;
            var e = a, g = /^\/[A-Z]:(\/.*)/;
    ...
    function pf() {
        ...
        this.html5Mode = function(a) {
            return Oa(a) ? (b.enabled = a, this) : J(a) ? (Oa(a.enabled) && (b.enabled = a.enabled), 
            Oa(a.requireBase) && (b.requireBase = a.requireBase), Oa(a.rewriteLinks) && (b.rewriteLinks = a.rewriteLinks), 
            this) : b;
        };
        ...
        S(f.prototype, {
            ...
            $$resolve: function(a) {
                ...
                try {
                    ...
                    D(g) ? (this.promise.$$state.status = -1, g.call(a, d, f, c(this, this.notify))) : (this.promise.$$state.value = a, 
                    this.promise.$$state.status = 1, e(this.promise.$$state));
                } catch (l) {
                    f(l), b(l);
                }
            },
            ...
            m.prototype = {
                ...
                $watchCollection: function(a, b) {
                    function c(a) {
                        ...
                        var b, d, g, h;
                        if (!z(e)) {
                            if (J(e)) if (za(e)) for (f !== n && (f = n, v = f.length = 0, l++), a = e.length, 
                            v !== a && (l++, f.length = v = a), b = 0; b < a; b++) h = f[b], g = e[b], d = h !== h && g !== g, 
                            d || h === g || (l++, f[b] = g); else {
                                f !== p && (f = p = {}, v = 0, l++);
                                a = 0;
                                for (b in e) va.call(e, b) && (a++, g = e[b], h = f[b], b in f ? (d = h !== h && g !== g, 
                                d || h === g || (l++, f[b] = g)) : (v++, f[b] = g, l++));
                                if (v > a) for (b in l++, f) va.call(e, b) || (v--, delete f[b]);
                            } else f !== e && (f = e, l++);
                            return l;
                        }
                    }
                    ...
                    do {
                        ...
                        a: do {
                            if (p = F.$$watchers) for (r = p.length; r--; ) try {
                                if (a = p[r]) if (m = a.get, (g = m(F)) !== (k = a.last) && !(a.eq ? na(g, k) : "number" === typeof g && "number" === typeof k && isNaN(g) && isNaN(k))) q = !0, 
                                c = a, a.last = a.eq ? pa(g, null) : g, l = a.fn, l(g, k === s ? g : k, F), 5 > t && (z = 4 - t, 
                                A[z] || (A[z] = []), A[z].push({
                            ...
                            if (!(p = F.$$watchersCount && F.$$childHead || F !== this && F.$$nextSibling)) for (;F !== this && !(p = F.$$nextSibling); ) F = F.$parent;
                        } while (F = p);
            ...
            return {
                ...
                getTrusted: function(d, e) {
                    ...
                    if (d === ma.RESOURCE_URL) {
                        ...
                        if (q) for (n = 0, p = b.length; n < p; n++) if (c(b[n], g)) {
                            q = !1;
                            break;
                        }
                        if (q) return e;
    ...
    function xd(a) {
        ...
        return function() {
            ...
            k = g.indexOf("="), 0 < k && (l = b(g.substring(0, k)), z(c[l]) && (c[l] = b(g.substring(k + 1))));
            return c;
        };
    }
    function Gf() {
    ...
    function Ma(a, b, d, c, e) {
        ...
        switch (f) {
          case "object":
            ...
            if ("object" === g) {
                for (h in b) if (e = b[h], !D(e) && !z(e) && (f = "$" === h, !Ma(f ? a : a[h], e, d, f, f))) return !1;
                return !0;
            }
            return d(a, b);
    ...
    function Id(a) {
        ...
        c.$setValidity = function(a, e, f) {
            z(e) ? (c.$pending || (c.$pending = {}), g(c.$pending, a, f)) : (c.$pending && h(c.$pending, a, f), 
            Nd(c.$pending) && (c.$pending = u));
            Oa(e) ? e ? (h(c.$error, a, f), g(c.$$success, a, f)) : (g(c.$error, a, f), h(c.$$success, a, f)) : (h(c.$error, a, f), 
            h(c.$$success, a, f));
            c.$pending ? (b(Od, !0), c.$valid = c.$invalid = u, d("", null)) : (b(Od, !1), c.$valid = Nd(c.$error), 
    ...
    q({
        ...
        attr: function(a, b, d) {
            var c = a.nodeType;
            if (c !== Pa && 2 !== c && 8 !== c) if (c = N(b), Eb[c]) if (A(d)) d ? (a[b] = !0, 
            a.setAttribute(b, c)) : (a[b] = !1, a.removeAttribute(c)); else return a[b] || (a.attributes.getNamedItem(b) || E).specified ? c : u; else if (A(d)) a.setAttribute(b, d); else if (a.getAttribute) return a = a.getAttribute(b, 2), 
            null === a ? u : a;
        },
        prop: function(a, b, d) {
        ...
        on: function(a, b, d, c) {
            ...
            if (Kc(a)) {
                ...
                for (var g = c.length, h = function(b, c, g) {
                    ...
                    h.push(d);
                }; g--; ) b = c[g], zb[b] ? (h(zb[b], Qf), h(b, u, !0)) : h(b);
            }
        },
        off: Oc,
        one: function(a, b, d) {
    ...
    } ], Tf = /^([^\(]+?)=>/, Uf = /^[^\(]*\(\s*([^\)]*)\)/m, Ag = /,/, Bg = /^\s*(_?)(\S+?)\1\s*$/, Sf = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Ia = O("$injector");
    eb.$$annotate = function(a, b, d) {
        ...
        } else M(a) ? (b = a.length - 1, Sa(a[b], "fn"), c = a.slice(0, b)) : Sa(a, "fn", !0);
        return c;
    };
    ...
    var Vc = /^((?:x|data)[\:\-_])/i, Zf = O("$controller"), ad = /^(\S+)(\s+as\s+([\w$]+))?$/, gf = function() {
    ...
    var Dg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, dg = {
        ...
        search: function(a, b) {
            switch (arguments.length) {
              ...
              case 1:
                if (y(a) || R(a)) a = a.toString(), this.$$search = xc(a); else if (J(a)) a = pa(a, {}), 
                q(a, function(b, c) {
                    null == b && delete a[c];
    ...
    gc.prototype = {
        ...
        readString: function(a) {
            ...
            for (var d = "", c = a, e = !1; this.index < this.text.length; ) {
                ...
                this.index += 4, d += String.fromCharCode(parseInt(e, 16))) : d += Fg[f] || f, e = !1; else if ("\\" === f) e = !0; else {
                    if (f === a) {
                        this.index++;
                        this.tokens.push({
                            index: b,
    ...
    rd.prototype = {
        ...
        recurse: function(a, b, d, c, e, f) {
            var g, h, k = this, l, m;
            c = c || E;
            if (!f && A(a.watchId)) b = b || this.nextId(), this.if_("i", this.lazyAssign(b, this.computedMember("i", a.watchId)), this.lazyRecurse(a, b, d, c, e, !0)); else switch (a.type) {
              case s.Program:
    ...
    sd.prototype = {
        ...
        computedMember: function(a, b, d, c, e) {
            return function(f, g, h, k) {
                var l = a(f, g, h, k), m, n;
                null != l && (m = b(f, g, h, k), m += "", Wa(m, e), c && 1 !== c && (Hb(l), l && !l[m] && (l[m] = {})), 
                n = l[m], ta(n, e));
                return d ? {
                    context: l,
                    name: m,
    ...
    }, vg = /((?:[^yMLdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|L+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/, ug = /^\-?\d+$/;
    zd.$inject = [ "$locale" ];
                    ...
                    return {
                        pre: function(a, d, e, f) {
                            ...
                            g && (q(a, n), e.$observe(g, function(b) {
                                n.$name !== b && (q(a, u), n.$$parentForm.$$renameControl(n, b), q = c(n.$name), 
                                q(a, n));
                            }));
                            d.on("$destroy", function() {
    ...
    var Ce = [ "$animate", "$compile", function(a, b) {
    ...
    }, pb = "ng-valid", Md = "ng-invalid", Xa = "ng-pristine", Lb = "ng-dirty", Od = "ng-pending", ob = O("ngModel"), Lg = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, b, d, c, e, f, g, h, k, l) {
        ...
        this.$$updateEmptyClasses = function(a) {
            r.$isEmpty(a) ? (f.removeClass(c, "ng-not-empty"), f.addClass(c, "ng-empty")) : (f.removeClass(c, "ng-empty"), 
        ...
        this.$$runValidators = function(a, b, c) {
            ...
            (function() {
                ...
                if (z(x)) f(a, null); else return x || (q(r.$validators, function(a, b) {
                    f(b, null);
        ...
        this.$commitViewValue = function() {
            var a = r.$viewValue;
            g.cancel(y);
            if (r.$$lastCommittedViewValue !== a || "" === a && r.$$hasNativeValidators) r.$$updateEmptyClasses(a), 
            r.$$lastCommittedViewValue = a, r.$pristine && this.$setDirty(), this.$$parseAndValidate();
        };
        this.$$parseAndValidate = function() {
            var b = r.$$lastCommittedViewValue;
            if (x = z(b) ? u : !0) for (var c = 0; c < r.$parsers.length; c++) if (b = r.$parsers[c](b), 
            z(b)) {
                x = !1;
                break;
            }
        ...
        a.$watch(function() {
            ...
            if (b !== r.$modelValue && (r.$modelValue === r.$modelValue || b === b)) {
                ...
                r.$viewValue !== e && (r.$$updateEmptyClasses(e), r.$viewValue = r.$$lastCommittedViewValue = e, 
                r.$render(), r.$$runValidators(b, e, E));
            }
            return b;
        });
        ...
        terminal: !0,
        priority: 1e3
    }), Ng = O("ngOptions"), Og = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/, Ne = [ "$compile", "$parse", function(a, b) {
        function d(a, c, d) {
                ...
                post: function(b, g, h, k) {
                    ...
                    function s() {
                        ...
                        C.items.forEach(function(a) {
                            var f, h;
                            A(a.group) ? (f = b[a.group], f || (f = m(g[0], d, "optgroup", e), d = f.nextSibling, 
                        ...
                        if (!x.$isEmpty(a)) {
                            var f = u.readValue();
                            (z.trackBy || r ? na(a, f) : a === f) || (x.$setViewValue(f), x.$render());
                        }
                    }
                    ...
                    r ? (x.$isEmpty = function(a) {
                        ...
                        b && !b.disabled ? (g[0].value !== b.selectValue && (G.remove(), t || w.remove(), 
                        g[0].value = b.selectValue, b.element.selected = !0), b.element.setAttribute("selected", "selected")) : null === a || t ? (G.remove(), 
                        t || g.prepend(w), g.val(""), w.prop("selected", !0), w.attr("selected", !0)) : (t || w.remove(), 
                        g.prepend(G), g.val("?"), G.prop("selected", !0), G.attr("selected", !0));
                    }, u.readValue = function() {
        ...
        return {
            link: function(f, g, h) {
                ...
                f.$watch(l, function(b) {
                    ...
                    c === v || e && R(v) && isNaN(v) || (w(), e = s[c], z(e) ? (null != b && d.debug("ngPluralize: no rule defined for '" + c + "' in " + m), 
                    w = E, k()) : w = f.$watch(e, k), v = c);
                });
            }
        };
            ...
            compile: function(f, g) {
                ...
                return function(a, d, f, g, l) {
                    ...
                    a.$watchCollection(n, function(f) {
                        ...
                        A = I.length;
                        J = Array(A);
                        for (g = 0; g < A; g++) if (E = f === I ? g : I[g], H = f[E], D = n(E, H, g), m[D]) F = m[D], 
                        delete m[D], t[D] = F, J[g] = F; else {
        ...
        d.writeValue = function(b) {
            d.hasOption(b) ? (d.removeUnknownOption(), a.val(b), "" === b && d.emptyOption.prop("selected", !0)) : null == b && d.emptyOption ? (d.removeUnknownOption(), 
    ...
    je(ea), ea.module("ngLocale", [], [ "$provide", function(a) {
        function b(a) {
            a += "";
            var b = a.indexOf(".");
...
Rt3Api.prototype.getOTARates = function(params) {
    var searchParams, startDate, endDate, retResponse = {}, reztripRate, brg = {}, brgFound;
    var defered = $.Deferred();
    var now = new Date();
    var day = ("0" + now.getDate()).slice(-2);
    var month = ("0" + (now.getMonth() + 1)).slice(-2);
...
Rt3Api.prototype.rateCalendarForToday = function(searchParams) {
    ...
    var endDate = endFullDate.toISOString().slice(0, 10);
    var defaultParams = {
        hotel_id: this.config.hotelId,
        portal_id: this.config.portalId,
        locale: this.config.defaultLocale,
...
(function() {
    angular.module("rezTrip", [], function($interpolateProvider) {
        ...
        $q.when(rt3SpecialRates.ready).then(function(response) {
            ...
            var oName = window.location.hash.substr(1);
            var tmpName;
...
(function(modules) {
    ...
    (function($) {
        $.fn.RTwidgets = function(options) {
            ...
            var widget_settings = $.extend(true, {}, defaults, options);
    ...
    var rt_offer_popup_widget = function() {
        function rt_offer_popup_widget(options) {
            ...
            this.settings.offer_popup_widget.timeout = options.offer_popup_widget.timeout || 5e3;
        }
...
angular.module("rezTrip").service("rt3HotelInfo", [ "$rootScope", "$q", "rt3api", function($rootScope, $q, rt3api) {
    var hotelInfo = {
        loaded: false,
        galleryImg: []
    };
...
angular.module("rezTrip").directive("rt3HotelInfo", [ "rt3HotelInfo", function(rt3HotelInfo) {
    return {
        restrict: "A",
        scope: true,
        link: function(scope, element, attrs) {
...
angular.module("rezTrip").filter("isArray", [ function() {
    ...
    return function(value) {
        ...
        retString = retString.replace(/^\s\s*/, "").replace(/\s\s*$/, "");
        retString = retString.replace("%", "percent");
        retString = retString.replace(/[^A-Z0-9]+/gi, "-");
        retString = retString.replace(/^--s*/, "").replace(/--*$/, "");
